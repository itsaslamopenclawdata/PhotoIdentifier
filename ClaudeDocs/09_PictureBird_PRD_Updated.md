# PRD: Picture Bird — Bird Identifier
...
| Field | Details |
|---|---|
| **Document Title** | Picture Bird: Bird Identifier — Product Requirements Document |
| **Version** | 1.0 |
...
- **Willingness to Pay:** GBP9.99/month for a comprehensive birding platform.
...
### Design System
- **Font:** Inter for all text (headings, body, UI elements)
- **Primary Color:** Indigo `#6366F1`
- **Accent:** Emerald `#10B981`
- **Background:** White/light gray
- **Border Radius:** 12px for cards, 8px for buttons
- **Spacing:** 4px base unit
- **Shadows:** 5-level shadow system (subtle to prominent elevation)
...
*Document Version 1.0 — Picture Bird PRD — PhotoIdentifier Platform | 2026-02-21*
