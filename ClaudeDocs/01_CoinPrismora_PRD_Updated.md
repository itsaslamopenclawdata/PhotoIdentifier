# PRD: CoinPrismora — AI Coin Identifier
...
| Field | Details |
|---|---|
| **Document Title** | CoinPrismora: AI Coin Identifier — Product Requirements Document |
| **Version** | 1.0 |
...
- **O1:** Establish CoinPrismora as the most-used web-based coin identifier.
...
|---|---|---|
| Image Capture | Upload photo or use live camera to capture coin | Supports JPEG, PNG, HEIC; min 512x512px resolution |
...
*Document Version 1.0 — CoinPrismora PRD — PhotoIdentifier Platform | 2026-02-21*
