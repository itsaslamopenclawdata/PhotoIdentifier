# PRD: Note Snap — Banknote Identifier
...
| Field | Details |
|---|---|
| **Document Title** | Note Snap: Banknote Identifier — Product Requirements Document |
| **Version** | 1.0 |
...
**Note Snap** is an AI-powered banknote identification, authentication, and collector portfolio management platform. Users photograph any banknote from any country and receive instant identification, exchange rate lookup, authentication guidance, cultural/historical context, and collector market valuation. The app serves three distinct segments: **travelers** needing exchange rate intelligence, **currency collectors** (notaphilists) managing portfolios, and **businesses** needing counterfeit detection tools.

Counterfeit currency causes **$80 million+ in losses annually** in the US alone. Globally, the numismatic currency collection market exceeds $3 billion. Note Snap uniquely addresses both the safety/verification need and the collector hobby market in one unified platform.

**Proposed Brand Name:** CurrencyLens
...
### Design System
- **Font:** Inter for all text — modern, highly legible, financial professionalism
- **Primary Color:** Indigo `#6366F1` — modern, trustworthy, accessible
- **Authentic Indicator:** Emerald `#10B981` — clear confidence signal
- **Suspect Indicator:** Red `#EF4444` — urgent attention, high contrast
...
- **Shadows:** 5-level shadow system
  ...
  - Level 3: `0 4px 6px -1px rgb(0 0 0 / 0.1), 0 2px 4px -2px rgb(0 0 0 / 0.1)` — raised cards
  - Level 4: `0 10px 15px -3px rgb(0 0 0 / 0.1), 0 4px 6px -4px rgb(0 0 0 / 0.1)` — modals, dropdowns
  - Level 5: `0 20px 25px -5px rgb(0 0 0 / 0.1), 0 8px 10px -6px rgb(0 0 0 / 0.1)` — tooltips, flyouts
...
*Document Version 1.0 — Note Snap PRD — PhotoIdentifier Platform | 2026-02-21*
