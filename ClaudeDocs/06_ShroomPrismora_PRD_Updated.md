# PRD: ShroomPrismora — AI Mushroom Identifier
...
| Field | Details |
|---|---|
| **Document Title** | ShroomPrismora: Identifier — Product Requirements Document |
| **Version** | 1.0 |
...
### Design System
- **Font:** Inter (400/700) — modern, highly legible typeface for safety-critical information
- **Color:** Indigo `#6366F1` primary, Red `#EF4444` for toxic warnings, Amber `#F59E0B` for uncertain
- **Border Radius:** 12px for cards, 8px for buttons
- **Spacing:** 4px base unit — all margins/padding are multiples of 4
- **Shadows:** 5-level shadow system
  ...
  - Level 3: `0 4px 6px -1px rgb(0 0 0 / 0.1), 0 2px 4px -2px rgb(0 0 0 / 0.1)`
  - Level 4: `0 10px 15px -3px rgb(0 0 0 / 0.1), 0 4px 6px -4px rgb(0 0 0 / 0.1)`
  - Level 5: `0 20px 25px -5px rgb(0 0 0 / 0.1), 0 8px 10px -6px rgb(0 0 0 / 0.1)`
...
*Document Version 1.0 — ShroomPrismora PRD — PhotoIdentifier Platform | 2026-02-21*
