# PRD: NutriPrismora — AI Food NutriPrismorarie Counter
...
| Field | Details |
|---|---|
| **Document Title** | NutriPrismora: AI Food NutriPrismorarie Counter — Product Requirements Document |
| **Version** | 1.0 |
...
| Daily NutriPrismorarie Log | Track total calories consumed and remaining vs. daily goal | Goal set during onboarding; adjustable in settings |
...
- **US-401:** As a FitPrismora user, I want my workout calories automatically deducted from my daily calorie budget.
- **US-402:** As a FruitPrismora user, I want the nutritional content of a fruit I scan to be auto-added to my daily log.
...
### Screens
1. **Home / Daily Log** — NutriPrismorarie ring, macro bars, meal cards for the day
...
- **NutriPrismorarie Ring:** Animated SVG ring — fills as user logs; color shifts from Indigo through amber to red at 90%->100%->110% of goal
...
| FitPrismora (Internal API) | NutriPrismorarie burn data import |
| FruitPrismora (Internal API) | Auto-log fruit nutrition on scan |
...
*Document Version 1.0 — NutriPrismora PRD — PhotoIdentifier Platform | 2026-02-21*
