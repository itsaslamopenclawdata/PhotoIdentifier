...
| Field | Details |
|---|---|
| **Document Title** | Dog Breed Identifier — Product Requirements Document |
| **Version** | 1.0 |
...
### Design System
- **Font:** Inter (400/700) — clean, modern, highly legible across all screen sizes
- **Primary Color:** Indigo `#6366F1` — trustworthy, intelligent, professional
- **Accent Color:** Amber `#F59E0B` — energetic, playful accent for highlights and CTAs
- **Background:** White `#FFFFFF` and Light Gray `#F9FAFB` — clean foundation replacing cream tones
- **Border Radius:** 12px for cards, 8px for buttons — consistent rounded elements
- **Spacing:** 4px base unit — all spacing multiples of 4px (8px, 12px, 16px, 24px, 32px, 48px)
- **Shadows:** 5-level shadow system
  - Shadow 1 (subtle): `0 1px 2px 0 rgb(0 0 0 / 0.05)`
  - Shadow 2 (light): `0 1px 3px 0 rgb(0 0 0 / 0.1), 0 1px 2px -1px rgb(0 0 0 / 0.1)`
  - Shadow 3 (medium): `0 4px 6px -1px rgb(0 0 0 / 0.1), 0 2px 4px -2px rgb(0 0 0 / 0.1)`
  - Shadow 4 (strong): `0 10px 15px -3px rgb(0 0 0 / 0.1), 0 4px 6px -4px rgb(0 0 0 / 0.1)`
  - Shadow 5 (elevated): `0 20px 25px -5px rgb(0 0 0 / 0.1), 0 8px 10px -6px rgb(0 0 0 / 0.1)`
...
*Document Version 1.0 — Dog Breed Identifier PRD — PhotoIdentifier Platform | 2026-02-21*
