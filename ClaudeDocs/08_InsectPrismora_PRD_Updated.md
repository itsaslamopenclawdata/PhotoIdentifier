# PRD: InsectPrismora — Bug Identifier
...
| Field | Details |
|---|---|
| **Document Title** | InsectPrismora: Bug Identifier — Product Requirements Document |
| **Version** | 1.0 |
...
| Pest Risk Advisory | Decision tree trained on crop x pest x region data from CABI |
...
### Design System
- **Font:** Inter for all modes (unified typography system)
- **Primary Color:** Indigo `#6366F1`
- **Pest Alerts:** Amber `#F59E0B`
- **Invasive Species:** Red `#EF4444`
- **Border Radius:** 12px for cards, 8px for buttons
- **Spacing:** 4px base unit (multiples: 8px, 12px, 16px, 24px, 32px, 48px)
...
*Document Version 1.0 — InsectPrismora PRD — PhotoIdentifier Platform | 2026-02-21*
