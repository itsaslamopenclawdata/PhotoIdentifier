# PRD: Star Snap — Sports Card Scanner
...
| Field | Details |
|---|---|
| **Document Title** | Star Snap: Sports Card Scanner — Product Requirements Document |
| **Version** | 1.0 |
...
### Design System
- **Font:** Barlow Condensed (700 headers) + Inter (body) — sports energy aesthetic
- **Color:** Deep Navy `#1E3A5F`, Gold `#F59E0B`, White `#FFFFFF`
...
*Document Version 1.0 — Star Snap PRD — PhotoIdentifier Platform | 2026-02-21*
