# PRD: AquaPrismora — Fish Care & Health
...
| Field | Details |
|---|---|
| **Document Title** | AquaPrismora: Fish Care & Health — Product Requirements Document |
| **Version** | 1.0 |
...
**AquaPrismora** is a comprehensive AI-powered aquarium companion platform that covers the entire lifecycle of freshwater and marine fishkeeping. The app identifies fish species from photos, diagnoses diseases and health conditions, monitors water parameters, designs aquascapes, and connects users with veterinary telehealth — all in one unified platform.
...
**Proposed Brand Name:** AquaPrismora Pro
...
// Response
{
  ...
  "treatment_protocol": {
    ...
    "temperature_adjust": "Raise to 30°C to speed parasite lifecycle",
...
### Design System
- **Font:** Nunito (400/700) — relaxed, hobby feel
- **Color:** Ocean Blue `#0366D6` primary, Coral `#FF6B6B` alerts, Aqua `#17A398` accents
...
*Document Version 1.0 — AquaPrismora PRD — PhotoIdentifier Platform | 2026-02-21*
