...
| Field | Details |
|---|---|
| **Document Title** | Rock Identifier: Stone ID — Product Requirements Document |
| **Version** | 1.0 |
...
### Design System
- **Font:** Merriweather (headings) + Source Sans Pro (body) — scientific authority aesthetic
- **Color:** Deep Earth Brown `#3D2B1F` background, Crystal Teal `#2ABFBF` primary, Quartz White `#F8F5F2`
...
*Document Version 1.0 — Rock Identifier PRD — PhotoIdentifier Platform | 2026-02-21*
