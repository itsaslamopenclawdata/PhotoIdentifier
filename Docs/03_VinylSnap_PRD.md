# PRD: Vinyl Snap — Scan & Value Record
...
| Field | Details |
|---|---|
| **Document Title** | Vinyl Snap: Scan & Value Record — Product Requirements Document |
| **Version** | 1.0 |
...
**Vinyl Snap** is an AI-powered vinyl record identification and valuation platform. Users photograph a record label or disc, and the system returns full album metadata, pressing variant information, current collector market value, and portfolio management tools for serious collectors. The vinyl revival — with global sales exceeding **$1.7 billion in 2024** — has created an enormous new population of collectors who lack efficient digital tools to manage their collections.

Vinyl Snap aims to be the definitive digital companion for vinyl enthusiasts, dealers, and casual thrift-shop diggers alike.
...
| Collection Value Dashboard | Total portfolio value with breakdown by artist/genre | Value calculated from median Discogs sold price × condition modifier |
...
### Design System
- **Font:** Playfair Display (headings) + Inter (body) — classic vinyl aesthetic, modern readability
- **Color:** Warm Cream `#F5F0E8` background, Deep Burgundy `#8B1E3F` primary, Gold `#D4A017` accent
- **Cards:** Album art prominently displayed; condition badge overlay
...
*Document Version 1.0 — VinylSnap PRD — PhotoIdentifier Platform | 2026-02-21*
