...
| Field | Details |
|---|---|
| **Document Title** | Plant Identifier — Product Requirements Document |
| **Version** | 1.0 |
...
**Plant Identifier** is an AI-powered botanical identification and garden management platform serving home gardeners, hikers, botanists, farmers, parents, and nature enthusiasts. Users photograph any plant, flower, tree, shrub, or succulent and immediately receive the species name, care instructions, toxicity warnings, medicinal uses, propagation guides, and seasonal care calendars.

The global plant identification app market is estimated at **$400M+ annually**, growing rapidly alongside the houseplant boom driven by younger demographics. Plant Identifier differentiates by combining the world's largest plant database (400,000+ species) with AI garden design, disease diagnosis, smart home water system integration, and a medicinal ethnobotanical knowledge layer.
...
| Seasonal Care Calendar | Month-by-month guide: prune, fertilize, repot, divide | Adapts to user's climate zone (Köppen classification zone input) |
...
└────┬───────────────┬───────────────────────────────┘
     │               │
┌────▼──────┐ ┌──────▼─────────────────────────┐
│ Plant ID  │ │ Disease Diagnosis Service      │
...
### Design System
- **Font:** Lora (serif headings) + Nunito (body) — natural, botanical aesthetic
- **Color:** Botanical Green `#2D6A4F` primary, Terracotta `#BC6C25` accent, Cream `#FAF3E0` background
...
*Document Version 1.0 — Plant Identifier PRD — PhotoIdentifier Platform | 2026-02-21*
